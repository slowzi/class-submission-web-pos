            ...
            <div class="col-xl-6">
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div class="col-sm-2 mt-3">
                            <input type="number" id="tahun-beli" class="form-control" value="<?= date('Y') ?>" onchange="chartTransaksiBeli()">
                        </div>
                    </div>
                    <div class="card-body"><canvas id="chartTransaksiBeli" width="100%" height="40"></canvas></div>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-outline-primary btn-sm" onclick="downloadChartTransaksiBeli('PDF')">Unduh PDF</button>
                        <a id="download-trans-beli" download="chart-transaksi-beli.png">
                            <button class="btn btn-outline-secondary btn-sm" onclick="downloadChartTransaksiBeli('PNG')">Unduh PNG</button>
                        </a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    // === PEMBELIAN ===
    function setLineChartBeli(dataset) {
        // Area Chart Example
        var ctx = document.getElementById("chartTransaksiBeli");
        var myLineChart = new Chart(ctx, {
            type: 'line',
            data: {
                labels: ["Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Ags", "Sep", "Okt", "Nov", "Des"],
    ...
    function setPieChart(dataset) {
        ...
        var myPieChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: dataset,
                    backgroundColor: ['#E9D5CA', '#827397', '#4D4C7D', '#363062', '#C2DED1', '#ECE5C7', '#CDC2AE', '#354259', '#92B4EC', '#9BA3EB'],
                }],
            },
            options: {
                legend: {
    ...
    function downloadChartTransaksiBeli(type) {
        var download = document.getElementById('download-trans-beli')
        var chart = document.getElementById('chartTransaksiBeli')

        if (type == "PNG") {
            downloadChartImg(download, chart)
        } else {
            downloadChartPDF(chart, "Chart-Transaksi-Beli.pdf")
        }
    }
